...
sheet_path = "C:\\Users\\ShailendraSingh\\Desktop\\ameri.xlsx"
def fhlmc_llpa(version,sheet_path):
    ...
    for ind ,ltv_val in enumerate( val["FICO"]):
        ...
        # print("hereis Cltv",val["LTV"][0]['values'][ind])

        # print("hereis first fico",val["LTV"][1]['values'][ind])
        # print("hereis second fico",val["LTV"][2]['values'][ind])
        ...
        json_value={
            ...
            "isCashOutRefinance": False,
            "product": val["Product"],
            # "productFeature": "Secondary Financing (Excludes HomePossible)",
    ...
    with open("json_dataFHLMC_LLPAsNew.jsonTest", "w") as j_file:
        # print("Hello")
        j_file.write(json_object)
    # return (main_fico_list)
    with open ("FNMA_productFeature.jsonTest","w") as jp_file:
        # print("Hello Again")
        jp_file.write(json_product_object)

    return (main_fico_list,product_feature_list)
fhlmc_llpa(1,"C:\\Users\\ShailendraSingh\\Desktop\\ameri.xlsx")
